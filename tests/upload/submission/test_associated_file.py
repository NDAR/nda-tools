...
def test_start_upload_happy_path(monkeypatch):
    with monkeypatch.context() as m:
        ...
        submission = Submission(submission_status=SubmissionStatus.UPLOADING, dataset_title='best cupcake data',
                                ...
                                dataset_created_date='05-14-2025', dataset_modified_date=None,
        ...
        m.setattr(NDATools.upload.submission.associated_file, 'get_s3_client_with_config',
        ...
        monkeypatch.setattr(pathlib.Path, 'stat', lambda x: MagicMock(st_size=2074))
